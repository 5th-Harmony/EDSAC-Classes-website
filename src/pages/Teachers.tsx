...
const Teachers = () => {
  ...
  const teachers = [
    ...
    },
    {
      ...
      qualification: 'PhD Physics, IISc Bangalore',
      experience: '8 years',
      rating: 4.7,
      reviews: 98,
      specializations: ['Quantum Mechanics', 'Quantum Computation', 'Statistical Data Science'],
      email: 'srijan.ghosh@edsac.edu',
      phone: '+91 91166 67860',
      officeHours: 'Tue-Thu 1:00-3:00 PM',
      avatar: '👨‍🔬',
      bio: 'Dr. Srijan brings cutting-edge research experience to the classroom, helping students understand the fascinating world of quantum physics.',
      achievements: ['Young Scientist Award', 'Nobel Prize X3 Winner', 'Bharat Ratna Award Winner'],
